...
// Like BotMk26 but without recreating CANCEL_SEARCH_TIMER each time
public class BotMk27 : IChessBot
{
	// TODO: total removable tokens: 55+198=253 -> currently at 1008/1024
	// ----------------
	// DATA CODE
	// ----------------
